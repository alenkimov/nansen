...
from better_web3 import Proxy as BetterWeb3Proxy
from python_socks.async_.asyncio import Proxy


class CustomIMAPClient(IMAP4_SSL):
    def __init__(self, *args, proxy: BetterWeb3Proxy = None, **kwargs):
        self.proxy = proxy
    ...
    async def create_socket_through_proxy(
        ...
        proxy = Proxy.from_url(self.proxy.as_url)
